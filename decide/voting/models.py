...
class Voting(models.Model):
    ...
    typePostproc = models.CharField(max_length=8, help_text='Debe elegir entre IDENTITY o DHONT como método de recuento', choices=(('IDENTITY', 'IDENTITY'), ('DHONT','DHONT')), default='IDENTITY')
    seats = models.PositiveIntegerField(default=0, help_text='Introduzca el número de escaños a repartir en caso de elegir DHONT')
