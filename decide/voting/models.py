...
class Voting(models.Model):
    ...
    typePostproc = models.CharField(max_length=8, help_text='Debe elegir entre IDENTITY o DHONT como método de recuento', 
                        choices=(('IDENTITY', 'IDENTITY'), ('DHONT','DHONT')), default='IDENTITY')
